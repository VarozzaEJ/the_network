    ...
    <div v-if="postProp.imgUrl">
        ...
        <div class="col-12 text-center d-flex justify-content-center align-items-center">
            <div class="card mb-5 mt-4 mx-4 w-75 ">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img :src="postProp.imgUrl" class="img-fluid rounded-start w-100 post-img h-100"
                            :alt="postProp.body">
                    </div>
                    <div class="col-md-7 ">
                                    ...
                                    <h5 v-if="postProp.creatorId == AppState.account?.id">
                                        <button title="Delete Your Post"
                                            ...
                                            class="btn btn-outline-danger"><i
                                                class=" text-start fs-2 mdi mdi-delete"></i>
                                        </button>
                                    </h5>
                                    <h5 v-if="(postProp.creatorId != AppState.account?.id)"
                            ...
                            <div class="card-body mt-5">
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="d-flex align-items-center justify-content-end mb-4 ">
                                        <p class="card-text fs-4 fw-bold me-2">{{ postProp.creator.name }}</p>
                                        <RouterLink
                                            :to="{ name: 'Profile', params: { profileId: postProp.creatorId } }">
                                            <img :title="`Navigate to ${postProp.creator.name}'s Profile Page`"
                                                class="img-fluid me-3 creator-img" :src="postProp.creator.picture"
                                                :alt="postProp.creator.name">
                                        </RouterLink>
                                        <!-- TODO like button is here -->
                                    </div>
